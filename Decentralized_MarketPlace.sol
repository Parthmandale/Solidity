...
contract Marketplace {
    ...
    function listedItems(string memory _name,string memory _description,uint256 _price) public {
        ...
        // item[itemCount] = Item(_name, _descrition, _price, payable(msg.sender), _availability); this is nice and shortcut method
    ...
    function placeOrder(uint256 _itemId) public payable {
        ...
        require(msg.value == newItem.price, "Icoorect Amount");
